...
Route::prefix('blog')->name('blog.')->group(function () {
    ...
    Route::get('/category/{title}', [UserFrontendController::class, 'blogsByCategory'])->name('category');
...
Route::prefix('packages')->name('packages.')->group(function () {
    Route::get('/search', [TourPackageController::class, 'search'])->name('search'); // 👈 MUST be above
...
Route::get('/gallery/images/{id}', [FrontGalleryController::class, 'show'])->name('gallery.album.showById');
