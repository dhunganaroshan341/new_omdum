    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div
                ...
                style="background-image: url('{{ asset('storage/'.$pageBanner->image ?? 'storage/'.'images/banner1.jpg') }}');"
            >
                    ...
                    <div class="row align-items-center d-flex h-100">
                        <div class="col-md-12">
                            <div class="block text-center">
                                ...
                                <p>
                                    {{ $pageBanner->description ?? 'We are a passionate digital design agency that specializes in beautiful and easy-to-use digital design & web development services.' }}
                                </p>
                            </div>
                        </div>
                    </div>
