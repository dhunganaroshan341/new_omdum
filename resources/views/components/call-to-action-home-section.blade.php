                ...
                <div class="col-lg-6 mb-4">
                    <div class="action-content">
                        ...
                        <p class="white mb-4">{!! $callToAction->description ??
                            'There are many variations of passages of. Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don’t look.' !!}</p>
                    ...
                    <div class="video-button">
                        ...
                        <div class="call-button text-center">
                            <button type="button" class="play-btn js-video-button"
                                data-video-id="{{ $callToAction->iframe ?: 'gCRNEJxDJKM' }}"
                                data-channel="{{ $callToAction->iframe ? 'custom' : 'youtube' }}">
        ...
        document.querySelectorAll('.js-video-button').forEach(button => {
            button.addEventListener('click', () => {
                ...
                if (channel === 'youtube') {
                    ...
                    iframeSrc = videoId; // Assuming full iframe URL here
                }

                // Now open your popup modal and set the iframe src to iframeSrc
                openVideoPopup(iframeSrc);
            });
        });
    </script>
@endpush
