<section class="section-3 py-5">
  <div class="container">
    ...
    <div class="position-relative">
          ...
          @foreach ($posts as $post)
            <div class="card border-0 flex-shrink-0 blog-card">
              ...
              <div class="card-body p-3 d-flex flex-column">
                <h1 class="card-title-blog mt-2 mb-2" style="
                    height: 3rem;
                    overflow: hidden;
                ...
                <div class="content pt-2 flex-grow-1" style="
                    height: 5rem;
                    overflow: hidden;
                    text-overflow: ellipsis;
                    display: -webkit-box;
      ...
      <!-- Navigation Buttons -->
      <button id="prevBtn" class="btn btn-secondary position-absolute top-50 start-0 translate-middle-y z-1 opacity-50">
  <i class="fa fa-chevron-left"></i>
</button>
<button id="nextBtn" class="btn btn-secondary position-absolute top-50 end-0 translate-middle-y z-1 opacity-50">
