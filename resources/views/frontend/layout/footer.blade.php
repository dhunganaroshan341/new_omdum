...
<footer class="pt-10"
    ...
    <div class="footer-upper pb-5">
        <div class="container">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="footer-listing white">
                        ...
                        <p class="mb-2 no-wrap">
                            ...
                            @if ($landline1 ?? false)
                                | <a href="tel:+977{{ $landline1 }}" class="text-white">+977 {{ $landline1 }}</a>
                            @endif
                        </p>
                        <p class="mb-0">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="footer-listing white">
                        ...
                        @if ($phone3 ?? false)
                            <p class="mb-2">
                                <i class="inline-icon fas fa-phone me-2"></i>
                                <a href="tel:+91{{ $phone3 }}" class="text-white">+91 {{ $phone3 }}</a>
                            </p>
                        @endif
                        @if ($phone4 ?? false)
                            <p class="mb-2">
                                <i class="inline-icon fas fa-phone me-2"></i>
                                <a href="tel:+91{{ $phone4 }}" class="text-white">+91 {{ $phone4 }}</a>
                            </p>
                        @endif
                        <p class="mb-0">
                            <i class="inline-icon fas fa-envelope me-2"></i>
            ...
            <!-- LINKS ROW (optional: stays below 3 boxes) -->
            <div class="row mt-4">
                <div class="col-12">
                    <div class="footer-links text-center">
                        <ul class="list">
                            <li><a href="{{ route('frontend.booking-single') }}">Book Now</a></li>
        ...
        <div class="container">
            <div class="copyright-inner">
                <div class="copyright-text text-center">
                    <p class="m-0 white">copyright@ommundumtreks2025 | Developed by
                        <a style="text-decoration: none;color:white" href="https://realminfotek.com/">
                            Realminfotech Pvt Ltd.
                        </a>
                    </p>
                </div>
            </div>
