...
<li aria-current="page" class="breadcrumb-item active">Confirmation</li>
</ul>
</nav>
</div>
</div>
...
<li class="border-b pb-1 mb-1"><span class="font-weight-bold">Email</span>: <a class="grey" href="mailto:support@Yatriiworld.com">support@Yatriiworld.com</a></li>
