            ...
            <div class="row gx-lg-5">
                <div class="col-lg-8">
                    <div class="single-content">
                        ...
                        @include('components.tour-pacage-imageslider')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.accordion-title').on('click', function() {
                var accordion = $(this).closest('.accordion'); // corrected spelling
                var content = accordion.find('.accordion-content');

                // Close all other accordions except the current one
                $('.accordion').not(accordion).removeClass('active').find('.accordion-content').slideUp();

                // Toggle current accordion open/close
            ...
            $('#booking-form').on('submit', function(e) {
                ...
                responseContainer.html(''); // Clear previous messages
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        responseContainer.html('<div class="alert alert-success">' + response
                            .message + '</div>');
                        form.trigger('reset'); // Clear form on success
                    },
                    error: function(xhr) {
