...
@section('content')
<!-- BreadCrumb Starts -->
<section class="breadcrumb-main pt-0" style="background-image: url('{{ asset('template/yatri_world/main-file/images/bg/bg8.jpg') }}');">
<div class="breadcrumb-outer pt-10 pb-4">
<div class="container">
<div class="breadcrumb-content d-md-flex align-items-center pt-10">
<h2 class="mb-0">Car Single</h2>
<nav aria-label="breadcrumb">
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="#">Home</a></li>
<li aria-current="page" class="breadcrumb-item active">Car Single</li>
</ul>
</nav>
</div>
</div>
...
<h3 class="mb-0">Audi A3 1.6 TDI S line</h3>
...
<div class="detail-slider-item">
<img alt="image" src="{{ asset('template/yatri_world/main-file/images/cars/2.jpg') }}"/>
</div>
<div class="detail-slider-item">
<img alt="image" src="{{ asset('template/yatri_world/main-file/images/cars/3.jpg') }}"/>
</div>
<div class="detail-slider-item">
<img alt="image" src="{{ asset('template/yatri_world/main-file/images/cars/4.jpg') }}"/>
</div>
<div class="detail-slider-item">
<img alt="image" src="{{ asset('template/yatri_world/main-file/images/cars/5.jpg') }}"/>
</div>
<div class="detail-slider-item">
<img alt="image" src="{{ asset('template/yatri_world/main-file/images/cars/6.jpg') }}"/>
</div>
<div class="detail-slider-item">
<img alt="image" src="{{ asset('template/yatri_world/main-file/images/cars/7.jpg') }}"/>
</div>
</div>
...
<div class="para-content d-flex align-items-center justify-content-between pb-2 border-b mb-2">
<span class="grey"><i class="fa fa-tachometer-alt me-1"></i> 49993 mi</span>
<span class="grey"><i class="fa fa-eye-dropper me-1"></i> Diesel</span>
<span class="grey"><i class="fa fa-meteor me-1"></i> Automatic</span>
<span class="grey"><i class="fa fa-calendar me-1"></i> Calender</span>
</div>
...
<p>When you pick up your car a deposit is usually held on your card for your excess which may be charged if the vehicle is damaged. Take our Damage Excess Refund and if you have any bumps or scrapes we'll refund any deductions from your excess.</p>
<ul class="list mb-2">
<li class="d-block mb-2"><i class="fa fa-star"></i> <span>You're protected</span> - Damage Excess Refund protects you when things go wrong and you are required to pay out from your excess</li>
<li class="d-block mb-2"><i class="fa fa-star"></i> <span>Accidents covered</span>  - Your excess will be protected if your vehicle is damaged in an accident</li>
<li class="d-block"><i class="fa fa-star"></i> <span>Damage cover</span>  - Damage to bodywork, vehicle parts and accessories incurred during most driving incidents is covered.</li>
</ul>
