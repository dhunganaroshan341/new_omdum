...
<h2 class="mb-0">Train Booking</h2>
<nav aria-label="breadcrumb">
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="#">Home</a></li>
<li aria-current="page" class="breadcrumb-item active">Train Booking</li>
</ul>
</nav>
</div>
</div>
...
<img alt="image" src="{{ asset('template/yatri_world/main-file/images/trains/1.jpg') }}"/>
...
<h4 class="mb-0 p-0 bordernone"><a class="" href="#" tabindex="0">Tokyo Serviced Apartment, Tokyo</a></h4>
<span>Japan</span>
</div>
</div>
</div>
