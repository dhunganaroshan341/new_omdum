...
<div>
<img alt="1" src="{{ asset('template/yatri_world/main-file/images/slider/1.jpg') }}"/>
</div>
<div>
<img alt="1" src="{{ asset('template/yatri_world/main-file/images/slider/2.jpg') }}"/>
</div>
<div>
<img alt="1" src="{{ asset('template/yatri_world/main-file/images/slider/3.jpg') }}"/>
</div>
<div>
<img alt="1" src="{{ asset('template/yatri_world/main-file/images/slider/7.jpg') }}"/>
</div>
<div>
<img alt="1" src="{{ asset('template/yatri_world/main-file/images/slider/8.jpg') }}"/>
</div>
<div>
<img alt="1" src="{{ asset('template/yatri_world/main-file/images/slider/2.jpg') }}"/>
</div>
...
<h3 class="choosen-date white mb-0"><i class="fa fa-calendar"></i> 10 - 15 March, 2020 <small class="d-block font-weight-normal">(5 days) <a class="d-block pink float-right" href="#">Change</a></small></h3>
</div>
</div>
<div class="col-lg-12">
<div class="form-group">
...
<ul>
<li class="d-block pb-1">$150.00 x 2 guests<span class="float-right pink">$300.00</span></li>
<li class="d-block pb-1">Booking fee + tax<span class="float-right pink">$10.00</span></li>
<li class="d-block pb-1">Book now &amp; Save<span class="float-right pink">-$15</span></li>
<li class="d-block pb-1">Other fees<span class="float-right pink">Free</span></li>
...
<ul>
<li class="mb-2"><i class="fa fa-map-marker pink me-2"></i> Better than 99% of properties in London</li>
<li class="mb-2"><i class="fa fa-map-marker pink me-2"></i> Exceptional Location - Inside city center</li>
