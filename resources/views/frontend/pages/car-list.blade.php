...
<a href="#" style="background-image: url('{{ asset('template/yatri_world/main-file/images/cars/3.jpg') }}');"></a>
</div>
</div>
...
<span><i aria-hidden="true" class="fa fa-tachometer-alt"></i> 28.00</span>
<span><i aria-hidden="true" class="fa fa-tint"></i> Petrol</span>
<span><i aria-hidden="true" class="fa fa-project-diagram"></i> Auto</span>
<span><i aria-hidden="true" class="fa fa-calendar"></i> Calender</span>
</div>
</div>
<p>
...
<div class="trend-daily d-flex align-items-center mb-2 border-b pb-2">
...
<div class="col-lg-5 col-md-4 blog-height">
<div class="blog-image">
<a href="#" style="background-image: url('{{ asset('template/yatri_world/main-file/images/cars/1.jpg') }}');"></a>
</div>
</div>
<div class="col-lg-7 col-md-8">
<div class="trend-content-main">
...
<div class="col-lg-5 col-md-4 blog-height">
<div class="blog-image">
<a href="#" style="background-image: url('{{ asset('template/yatri_world/main-file/images/cars/4.jpg') }}');"></a>
</div>
</div>
<div class="col-lg-7 col-md-8">
<div class="trend-content-main">
...
<div class="col-lg-5 col-md-4 blog-height">
<div class="blog-image">
<a href="#" style="background-image: url('{{ asset('template/yatri_world/main-file/images/cars/2.jpg') }}');"></a>
</div>
</div>
<div class="col-lg-7 col-md-8">
<div class="trend-content-main">
...
<div class="col-lg-5 col-md-4 blog-height">
<div class="blog-image">
<a href="#" style="background-image: url('{{ asset('template/yatri_world/main-file/images/cars/6.jpg') }}');"></a>
</div>
</div>
<div class="col-lg-7 col-md-8">
<div class="trend-content-main">
...
<div class="col-lg-5 col-md-4 blog-height">
<div class="blog-image">
<a href="#" style="background-image: url('{{ asset('template/yatri_world/main-file/images/cars/5.jpg') }}');"></a>
</div>
</div>
<div class="col-lg-7 col-md-8">
<div class="trend-content-main">
...
<div class="col-lg-5 col-md-4 blog-height">
<div class="blog-image">
<a href="#" style="background-image: url('{{ asset('template/yatri_world/main-file/images/cars/7.jpg') }}');"></a>
</div>
</div>
<div class="col-lg-7 col-md-8">
<div class="trend-content-main">
