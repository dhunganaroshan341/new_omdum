...
@section('content')
<!-- BreadCrumb Starts -->
<div class="breadcrumb-main pt-9 pb-7" style="background-image: url('{{ asset('template/yatri_world/main-file/images/bg/bg8.jpg') }}');">
...
<li class="active"><a href="#"><i class="sl sl-icon-star"></i> Reviews</a></li>
