...
<div class="container">
<div class="row gy-4 flex-lg-row-reverse gx-lg-5">
<div class="col-lg-3">
<div class="sidebar-sticky sticky1">
<div class="tabs-navbar bg-lgrey mb-4">
<div class="row">
<div class="col-md-12">
<ul class="nav nav-tabs bordernone" id="tabs">
...
<li><a class="bordernone" data-toggle="tab" href="#single-add-review">Add Reviews</a></li>
</ul>
</div>
</div>
</div>
