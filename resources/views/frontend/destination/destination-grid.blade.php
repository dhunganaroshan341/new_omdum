...
<h2 class="mb-0">Destination Grid</h2>
<nav aria-label="breadcrumb">
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="#">Home</a></li>
<li aria-current="page" class="breadcrumb-item active">Destination Grid</li>
</ul>
</nav>
</div>
</div>
...
<p class="mb-1 white"><i aria-hidden="true" class="fa fa-clock-o"></i> 3 days &amp; 2
                                            night</p>
<div class="trend-price">
