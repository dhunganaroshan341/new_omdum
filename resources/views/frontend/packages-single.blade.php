                                ...
                                <div class="col-md-6 mb-2 pe-2">
                                    <div class="desc-box">
                                        ...
                                        <ul>
                                            ...
                                            @empty
                                                <li><i class="fa fa-check pink me-1"></i> All ground transports in
                                                    private vehicle including airport transfers</li>
                                                <li><i class="fa fa-check pink me-1"></i> Four nights accommodation with
                                                    breakfast at a 3-star category hotel in Kathmandu</li>
                                                <li><i class="fa fa-check pink me-1"></i> Kathmandu city tours including
                                                    all entry fees, tour guide and private vehicle</li>
                                                <li><i class="fa fa-check pink me-1"></i> Full board meals with
                                                    tea/coffee (breakfast, lunch and dinner) during the trek</li>
                                                <li><i class="fa fa-check pink me-1"></i> Best available twin sharing
                                                    lodge to lodge accommodation during the trek; private bathrooms with
                                                    hot shower at Phakding, Namche and Lukla</li>
                                                <li><i class="fa fa-check pink me-1"></i> Seasonal fruits during the
                                                    trek</li>
                                                <li><i class="fa fa-check pink me-1"></i> One highly experienced,
                                                    helpful and friendly guide, porters (1 porter for 2 people), and
                                                    their food, accommodation, salary, equipment, and accidental
                                                    insurance for all staff</li>
                                                <li><i class="fa fa-check pink me-1"></i> Round trip flight Kathmandu –
                                                    Lukla and Lukla – Kathmandu including departure taxes</li>
                                                <li><i class="fa fa-check pink me-1"></i> Duffle bag for the trekking
                                                </li>
                                                <li><i class="fa fa-check pink me-1"></i> Down jacket and sleeping bag
                                                    during the trek</li>
                                                <li><i class="fa fa-check pink me-1"></i> Nepal Hiking Team T-shirt,
                                                    trekking map and trip achievement certificate</li>
                                                <li><i class="fa fa-check pink me-1"></i> First aid medical kit</li>
                                                <li><i class="fa fa-check pink me-1"></i> Sagarmatha National Park
                                                    Permits fee</li>
                                                <li><i class="fa fa-check pink me-1"></i> TIMS Fee - Trekkers'
                                                    Information Management System (Please bring 2 passport size photos
                                                    for permit)</li>
                                                <li><i class="fa fa-check pink me-1"></i> Government taxes & office
                                                    service charge</li>
                                            @endforelse
                                        </ul>
                                    </div>
                                ...
                                <div class="col-md-6 mb-2 ps-2">
                                    <div class="desc-box">
                                        ...
                                        <ul>
                                            ...
                                            @empty
                                                <li><i class="fa fa-close pink me-1"></i> Meals not specified in the 'Meal
                                                    Inclusions' in the itinerary</li>
                                                <li><i class="fa fa-close pink me-1"></i> Travel insurance</li>
                                                <li><i class="fa fa-close pink me-1"></i> International airfare</li>
                                                <li><i class="fa fa-close pink me-1"></i> Nepal entry visa: obtainable on
                                                    arrival at Tribhuwan International Airport (30 days: USD 40, 90 days:
                                                    USD 100; bring 2 passport-size photos)</li>
                                                <li><i class="fa fa-close pink me-1"></i> Cold drinks including Coke, water,
                                                    Fanta, etc.</li>
                                                <li><i class="fa fa-close pink me-1"></i> Snacks and other personal expenses
                                                </li>
                                                <li><i class="fa fa-close pink me-1"></i> Hot shower during the trek except
                                                    in Phakding, Namche, and Lukla</li>
                                                <li><i class="fa fa-close pink me-1"></i> Personal trekking equipment</li>
                                                <li><i class="fa fa-close pink me-1"></i> Tips and gratuities for trekking
                                                    staff and drivers</li>
                                            @endforelse
                                        </ul>
                                    </div>
                                </div>
