            ...
            <div class="col-lg-9">
                <div class="post-detail section-container">
                    ...
                    <div class="post-by">
                      ...
                      @foreach ($post->tags ?? ['News'] as $tag)
                        ...
                        @endforeach
                        <span class="divider">|</span> {{ $comments->count() }} Comments
                    </div>
                ...
                <div class="section-container">
                    ...
                    <form class="form-horizontal" id="addComment">
                        ...
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-2 text-md-right">Your Name <span class="text-danger">*</span></label>
                            <div class="col-md-10">
                        ...
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-2 text-md-right">Your Email <span class="text-danger">*</span></label>
                            <div class="col-md-10">
                        ...
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-2 text-md-right">Comment <span class="text-danger">*</span></label>
                            <div class="col-md-10">
...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            error: function () {
                $('#searchResults').html('<p class="text-danger">Error fetching results. Try again.</p>');
            }
        });
    });
    });
