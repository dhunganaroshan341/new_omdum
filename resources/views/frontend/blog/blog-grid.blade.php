                        ...
                        <div class="col-md-6 mb-4">
                            <div class="blog-full text-center p-3">
                                ...
                                <div class="blog-content pb-0">
                                    ...
                                    <p class="date-cats mb-0 border-t pt-2 pb-2">
                                        <a class="me-2" href="#"><i class="fa fa-file"></i> Categories</a> <a
                                            class="" href="#"><i class="fa fa-user"></i> By Lorem
                                            Ipsum</a>
                                    </p>
                                    <p class="mb-2 border-t pt-2">Susp endisse ullam corper a adipiscing class ullam
                                        corper inceptos nisl consequat eros congue.</p>
                                        ...
                                        <div class="tab-pane fade show active" id="popular">
                                            ...
                                            <article class="post mb-2">
                                                <div class="s-content d-flex align-items-center justify-space-between">
                                                    ...
                                                    <div class="content-list ps-3">
                                                        ...
                                                        <h5 class="m-0"><a href="blog-single.html">Takes on Baboon,
                                                                and It Doesn’t Go Well for It</a></h5>
                                                    </div>
                                                </div>
                                            </article>
                                            <article class="post mb-2">
                                            ...
                                            <article class="post">
                                                <div class="s-content d-flex align-items-center justify-space-between">
                                                    ...
                                                    <div class="content-list ps-3">
                                                        <div class="date">Jun 28, 2024</div>
                                                        <h5 class="m-0"><a href="blog-single.html">African Reserve
                                                                Got Killed by Lions Instead</a></h5>
                                                    </div>
                                                </div>
                                            </article>
                                        </div>
