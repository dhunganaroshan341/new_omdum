            ...
            <form id="formId" class="form">
                ...
                <div class="modal-body row g-3">
                    ...
                    <div class="col-md-12 mt-4 mb-2">
                        ...
                        <textarea class="form-control summernote" id="testimonialDescription" name="long_description" rows="4"></textarea>
                    </div>


                    <div class="col-12">
                        <label>Itinerary</label>
                        <textarea name="itinerary" rows="4" class="form-control summernote"></textarea>
                    </div>
                </div>
