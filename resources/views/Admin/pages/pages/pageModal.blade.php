                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea type="text" class="form-control summernote" name="short_desc1" id="short_desc1">
                        </div>

                        <div class="col-md-6">
                            <label for="short_desc2" class="form-label ">Short Desc 2</label>
                            <textarea type="text" class="form-control summernote" name="short_desc2" id="short_desc2">
                        </div>
